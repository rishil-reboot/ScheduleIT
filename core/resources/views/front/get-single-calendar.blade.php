...
@section('pagename')
 - @if($calendar->meta_title !=null) {{$calendar->meta_title}} @else  {{__('Event Calendar')}} @endif
@endsection

@section('meta-keywords', "$calendar->meta_keywords")
@section('meta-description', "$calendar->meta_description")

@section('styles')

<link href='{{asset("assets/front/css/calendar.css")}}' rel='stylesheet' />
<link href='{{asset("assets/front/calendar/css/master.css")}}' rel='stylesheet' />
@endsection
        ...
        <div class="breadcrumb-txt" style="padding:{{$breadcumPadding}}">
           <div class="row">
              <div class="col-xl-7 col-lg-8 col-sm-10">
                 ...
                 <h1>{{convertUtf8($calendar->name)}}</h1>
                 <ul class="breadcumb">
