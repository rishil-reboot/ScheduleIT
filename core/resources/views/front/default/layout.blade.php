...
<html lang="en">
   ...
   <body @if($rtl == 1) dir="rtl" @endif class="@if(isset($themeSetting) && $themeSetting->calendar_theme ==  2) light-version @endif">
      ...
      <footer class="footer-section">
         <div class="container">
                        ...
                        <div class="col-lg-2 col-md-3">
                           ...
                           <ul class="footer-links">
                              @foreach($value2->ulink as $key3=>$value3)
                                 <li>
                                     <a href="{{$value3->url}}">{{$value3->name}}</a>
                                 </li>
                              @endforeach
                           </ul>
                        </div>
            ...
            <div class="copyright-section">
               <div class="row">
                  @if($bs->powered_by_section == 1)
                  <div class="col-sm-4 powered-by">
                     <a href="@if(!empty($bs->powered_by_url)) {{$bs->powered_by_url}} @else javascript:void(0) @endif" @if(!empty($bs->powered_by_url)) target="_blank" @endif>
                        <img src="{{asset('assets/front/img/'.$bs->powered_by_logo)}}">
                     </a>
                     <p>{!! $bs->powered_by_text !!}</p>
                  </div>
                  @endif
