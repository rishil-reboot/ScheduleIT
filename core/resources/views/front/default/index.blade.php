          ...
          <div class="row">
            @foreach ($features as $key => $feature)
                <style>
                    ...
                    .feature-custome-class{color: white;}


                </style>
                  <div class="col-md-3 col-sm-6 single-hero-feature sf{{$feature->id}}" style="background-color: #{{$feature->color}};">
                        @if(!empty($feature->external_link))
                        <a href="{{$feature->external_link}}" target="_blank">
                        @elseif($feature->page !=null)
                        <a href="{{route('front.dynamicPage',[$feature->page->slug])}}">
                        @else
                        <a href="javascript:void(0)">
                        @endif
                        <div class="outer-container feature-custome-class">
       ...
       <div class="row">
          <div class="col-lg-6 {{$rtl == 1 ? 'pl-lg-0' : 'pr-lg-0'}}">
             <div class="intro-txt">
                ...
                <a href="{{url($bs->intro_section_button_url)}}" class="intro-btn" target="_blank"><span>{{convertUtf8($bs->intro_section_button_text)}}</span></a>
                @endif
             </div>
          </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item mt-30">
                                ...
                                <div class="services-content">
                                    <a class="title" @if($service->details_page_status == 1) href="{{route('front.servicedetails', [$service->slug])}}" @endif><h4>{{convertUtf8($service->title)}}</h4></a>
                                    ...
                                    <a href="{{route('front.servicedetails', [$service->slug])}}">{{__('Read More')}} <i class="fas fa-plus"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="single-category">
                                ...
                                <div class="text">
                                    ...
                                    <a href="{{route('front.serviceCategory',$scategory->slug)}}" class="readmore">{{__('View Services')}}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                @foreach ($members as $key => $member)
                 <div class="single-team-member" data-link="{{route('front.dynamicMemberPage',$member->slug)}}">
                    <div class="team-img-wrapper">
                       <a href="{{route('front.dynamicMemberPage',$member->slug)}}">
        ...
        <div class="pricing-carousel common-carousel owl-carousel owl-theme">
          @foreach ($packages as $key => $package)
            <div class="single-pricing-table">
               ...
               <a href="{{route('front.packageorder.index', $package->slug)}}" class="pricing-btn">{{__('Place Order')}}</a>
               @endif
           ...
           @foreach ($blogs as $key => $blog)
              <div class="single-blog">
                 ...
                 <div class="blog-txt">
                    ...
                    <h4 class="blog-title" style="font-size: {{$blog->title_font_size}}px;font-family:{{$blog->title_font_style}}"><a href="{{route('front.blogdetails', [$blog->slug])}}">{{convertUtf8(strlen($blog->title)) > 40 ? convertUtf8(substr($blog->title, 0, 40)) . '...' : convertUtf8($blog->title)}}</a></h4>
