...
<!-- Form Builder -->
<script src="{{asset('assets/admin/js/plugin/form_builder/form-builder.min.js')}}"></script>
<script src="{{asset('assets/admin/js/plugin/form_builder/form-render.min.js')}}"></script>
<!-- jQuery Scrollbar -->
...
<!-- Custom JS -->
<script src="{{asset('assets/admin/js/custom.js')}}?time={{rand()}}"></script>
...
<script>
   $(document).ready(function(){
      ...
      var legendUrl = "{{GET_FAQ_LEGENDS_PAGE_URL()}}"; 

      $('.legendPage').attr('href',legendUrl);
