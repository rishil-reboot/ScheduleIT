...
@if (empty($admin->role) || (!empty($permissions) && in_array('Tickets', $permissions)))
  ...
  @endif
    ...
    @endif
		...
		@if (empty($admin->role) || (!empty($permissions) && in_array('Form Builder', $permissions)))
          {{-- Dynamic Pages --}}
          <li class="nav-item
        ...
        @endif
		@if (empty($admin->role) || (!empty($permissions) && in_array('Videos', $permissions)))
          {{-- Videos --}}
          <li class="nav-item
          @if(request()->path() == 'admin/vcategory') active
          @elseif(request()->is('admin/vcategory/*/edit')) active
          @elseif(request()->path() == 'admin/videos') active
          @elseif(request()->is('admin/videos/*/edit')) active
          @endif">
            ...
            <div class="collapse
            @if(request()->path() == 'admin/vcategorys') show
            @elseif(request()->is('admin/vcategory/*/edit')) show
            @elseif(request()->path() == 'admin/videos') show
            @elseif(request()->is('admin/videos/*/edit')) show
            @endif" id="videos">
              <ul class="nav nav-collapse">
                ...
                @elseif(request()->is('admin/vcategory/*/edit')) active
                @endif">
                  <a href="{{route('admin.vcategory.index') . '?language=' . $default->code}}">
                    <span class="sub-item">Category</span>
                  </a>
                </li>
                
                <li class="
                @if(request()->path() == 'admin/videos') active
                @elseif(request()->is('admin/videos/*/edit')) active
                @endif">
                  <a href="{{route('admin.videos.index') . '?language=' . $default->code}}">
                    <span class="sub-item">Videos</span>
                  </a>
                </li>
				  <li class="
                @if(request()->path() == 'admin/azure_brand') active
                @elseif(request()->is('admin/azure_brand/*/edit')) active
                @endif">
                  <a href="{{route('admin.azure_brand.index') . '?language=' . $default->code}}">
                    <span class="sub-item">Azure Brand</span>
                  </a>
                </li>
                <li class="
                @if(request()->path() == 'admin/azure_person_model') active
                @elseif(request()->is('admin/azure_person_model/*/edit')) active
                @endif">
                  <a href="{{route('admin.azure_person_model.index') . '?language=' . $default->code}}">
                    <span class="sub-item">Azure Person Model</span>
                  </a>
                </li>
				  <li class="
                @if(request()->path() == 'admin/azure_accounts') active
                @elseif(request()->is('admin/azure_accounts/*/edit')) active
                @endif">
                  <a href="{{route('admin.azure_accounts.index') . '?language=' . $default->code}}">
                    <span class="sub-item">Azure Accounts</span>
                  </a>
                </li>
              </ul>
            </div>
