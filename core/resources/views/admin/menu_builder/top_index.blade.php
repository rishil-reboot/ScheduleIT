...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Nav First Section</h4>
      ...
      <div class="card">
        ...
        <div class="card-body pt-5 pb-5">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                        <div class="card-header bg-primary text-white">Website Menus Nav First Section</div>
                        <div class="card-body">
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        $('#btnOutput').on('click', function () {
            ...
            $.ajax({
                url: "{{route('admin.top_menu_builder.update')}}",
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
