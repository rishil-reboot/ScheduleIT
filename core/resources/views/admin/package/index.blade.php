...
<div class="row">
   <div class="col-md-12">
       ...
       <div class="card">
         ...
         <form class="" action="{{route('admin.packages.updateSection')}}" method="post">
          @csrf
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="package_page_description" data-editor="package_page_description">
                    {!! $abs->package_page_description !!}
                  </textarea>
                  @if ($errors->has('package_page_description'))
                    <p class="mb-0 text-danger">{{$errors->first('package_page_description')}}</p>
                  @endif
                </div>
              </div>
            </div>
         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.package.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <input type="text" onkeyup="makeslug(this.value)" class="form-control" name="title" placeholder="Enter title" value="">
                      ...
                      <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <select id="price_type" name="price_type" class="form-control">
                                 <option value="" selected disabled>Select a price type</option>
                                 <option value="1">Per Week</option>
                                 <option value="2">Per month</option>
                                 <option value="3">Per year</option>
                              </select>
                              <p id="errprice_type" class="mb-0 text-danger em"></p>
                           </div>
                      </div>
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="description" data-editor="description" rows="8" cols="80" placeholder="Enter description" data-height="300"></textarea>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="ajaxEditForm" class="" action="{{route('admin.package.update')}}" method="POST">
               ...
               <div class="form-group">
                 <label for="">URL Slug **</label>
                 <input id="inslug" type="text" class="form-control" name="slug" placeholder="Enter SEO Friendly URL Slug" value="">
                 <p id="errslug" class="em text-danger mb-0"></p>
               </div>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-6">
                        ...
                        <div class="form-group">
                          <label for="">Price Type</label>
                          <select id="inprice_type" name="price_type" class="form-control">
                             <option value="">Select a price type</option>
                             <option value="1">Per Week</option>
                             <option value="2">Per month</option>
                             <option value="3">Per year</option>
                          </select>
                          <p id="eerrprice_type" class="mb-0 text-danger em"></p>
                       </div>
               ...
               <div class="form-group">
                  <label for="">Description **</label>
                  <textarea id="indescription" class="form-control summernote" name="description" data-editor="indescription" placeholder="Enter description" data-height="200"></textarea>
