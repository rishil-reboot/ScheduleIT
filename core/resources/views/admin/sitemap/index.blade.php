      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <i class="fa fa-info-circle hclass" style="font-size:35px" title="{{__('sitemap_help')}}" aria-hidden="true"></i>
                </div>
          ...
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.sitemap.store')}}" method="POST">
            ...
            <input type="hidden" name="filename">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="sitemap_url" placeholder="Enter Sitemap Url" value="{{url('/')}}">
                <p><strong>Note:</strong> {{__('sitemap_add_time_help')}} </p>
