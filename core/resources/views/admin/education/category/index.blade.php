        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    ...
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.educationCategory.bulk.delete')}}"><i class="flaticon-interface-5"></i> Delete</button>
                </div>
            </div>
        </div>
        <div class="card-body">
              ...
              @else
                <div class="table-responsive">
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      @foreach ($ecategorys as $key => $bcategory)
                        <tr>
                          <td>
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{route('admin.educationCategory.delete')}}" method="post">
                              @csrf
                              <input type="hidden" name="education_category_id" value="{{$bcategory->id}}">
        ...
        <div class="card-footer">
          <div class="row">
            <div class="d-inline-block mx-auto">
              {{$ecategorys->appends(['language' => request()->input('language')])->links()}}
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.educationCategory.store')}}" method="POST">
            @csrf
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>The higher the serial number is, the later the category will be shown.</small></p>
            </div>
          </form>
        </div>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.educationCategory.update')}}" method="POST">
            @csrf
            <input id="inbcategory_id" type="hidden" name="education_category_id" value="">
            <div class="form-group">
              <label for="">Name **</label>
