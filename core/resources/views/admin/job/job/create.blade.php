                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="jobRes" id="jobRes" name="job_responsibilities"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="eduReq" id="eduReq" name="educational_requirements"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="expReq" id="expReq" name="experience_requirements"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="addReq" id="addReq" name="additional_requirements"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="salary" id="salary" name="salary"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="benefits" id="benefits" name="benefits"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" data-editor="read_before_apply" id="read_before_apply" name="read_before_apply" data-height="150"
