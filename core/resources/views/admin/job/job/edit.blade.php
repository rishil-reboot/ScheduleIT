                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="jobRes" data-editor="jobRes" name="job_responsibilities" data-height="150"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="eduReq" data-editor="eduReq" name="educational_requirements" data-height="150"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="expReq" data-editor="expReq" name="experience_requirements" data-height="150"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="addReq" data-editor="addReq" name="additional_requirements" data-height="150"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="salary" data-editor="salary" name="salary" data-height="150"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="benefits" data-editor="benefits" name="benefits" data-height="150"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" id="read_before_apply" data-editor="read_before_apply" name="read_before_apply" data-height="150"
