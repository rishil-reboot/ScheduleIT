			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.member.index') }}?language=en">
							<div class="numbers">
		...
		<div class="card card-stats card-success card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.portfolio.index') }}?language=en">
							<div class="numbers">
		...
		<div class="card card-stats card-warning card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.blog.index') }}?language=en">
							<div class="numbers">
		...
		<div class="card card-stats card-danger card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.service.index') }}?language=en">
							<div class="numbers">
		...
		<div class="card card-stats card-secondary card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.page.index') }}?language=en">
							<div class="numbers">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.communityCalendar.index') }}">
							<div class="numbers">
								...
								<h4 class="card-title">{{ \App\Calendar::select('id')->count() }}</h4>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="card card-stats card-success card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.menu_builder.index') }}?language=en">
							<div class="numbers">
								<p class="card-category">Menu Builder</p>
				...
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.register.user') }}">
							<div class="numbers">
								<p class="card-category">Customer Management</p>
								<h4 class="card-title">{{ \App\User::select('id')->count() }}</h4>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="card card-stats card-secondary card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.faq.index') }}?language=en">
							<div class="numbers">
								<p class="card-category">FAQ</p>
								<h4 class="card-title">{{ \App\Faq::select('id')->count() }}</h4>
							</div>
						</a>
					</div>
				</div>
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.user.index') }}">
							<div class="numbers">
								...
								<h4 class="card-title">{{ \App\Admin::select('id')->count() }}</h4>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="card card-stats card-info card-round">
			<div class="card-body ">
				<div class="row">
					...
					<div class="col-7 col-stats">
						<a href="{{ route('admin.gallery.index') }}?language=en">
							<div class="numbers">
								<p class="card-category">Total Media Storage</p>
								<?php $tSize = (new \App\Gallery())->getTotalMedaiFileSize(); ?>
								<h4 class="card-title">{{ $tSize }}</h4>
							</div>
						</a>
					</div>
