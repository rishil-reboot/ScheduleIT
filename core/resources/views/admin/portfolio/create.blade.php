...
<l   ink rel="stylesheet" type="text/css" href="{{asset('assets/front/css/select2.min.css')}}">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <select id="bcategory" class="form-control" name="category_id[]" multiple>
...
<script>
   $(document).ready(function() {
       ...
       $("select[name='language_id']").on('change', functi      on() {

           $("#services").removeAttr('disabled');

           let l  angid = $(this).val();
           ...
           let urlCat = "{{url('/')}}/admin/portfolio-category/" + langid + "/getcats";
           // console.log(url);
