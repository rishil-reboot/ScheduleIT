              ...
              <form id="ajaxForm" class="" action="{{route('admin.portfolio.update')}}" method="post">
                ...
                <input type="hidden" name="portfolio_id" value="{{$portfolio->id}}">
                 ...
                 <?php
                  ...
                  $categoryArray = $portfolio->myPortfolioCategory->pluck('category_id')->toArray();
                ...
                <div class="row">
                  <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="category_id[]" id="bcategory" multiple>
                          @foreach ($bcats as $key => $bcat)
                            <option value="{{$bcat->id}}" {{ in_array($bcat->id,$categoryArray) ? 'selected' : ''}}>{{$bcat->name}}</option>
                          @endforeach
                        </select>
