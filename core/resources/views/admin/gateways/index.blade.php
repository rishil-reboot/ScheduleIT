            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" name="client_id" value="{{$paypalInfo["client_id"]}}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="password" name="client_secret" value="{{$paypalInfo["client_secret"]}}">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="key" type="password" value="{{$stripeInfo['key']}}">
                    @if ($errors->has('key'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="secret" value="{{$stripeInfo['secret']}}">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="secret" value="{{$paytmInfo['secret']}}">
                    @if ($errors->has('secret'))
                        <p class="mb-0 text-danger">{{$errors->first('secret')}}</p>
                    @endif
                </div>
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="merchant" value="{{$paytmInfo['merchant']}}">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="key" value="{{$instamojoInfo['key']}}">
                    @if ($errors->has('key'))
                        <p class="mb-0 text-danger">{{$errors->first('key')}}</p>
                    @endif
                </div>
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="token" value="{{$instamojoInfo['token']}}">
                    @if ($errors->has('token'))
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="key" type="password" value="{{$paystackInfo['key']}}">
                    @if ($errors->has('key'))
                        <p class="mb-0 text-danger">{{$errors->first('key')}}</p>
                    @endif
                </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="public_key" value="{{$flutterwaveInfo['public_key']}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="secret_key" value="{{$flutterwaveInfo['secret_key']}}">
            ...
            <div class="card-body pt-5 pb-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="key" value="{{$mollieInfo['key']}}">
                        @if ($errors->has('key'))
                            <p class="mb-0 text-danger">{{$errors->first('key')}}</p>
                        @endif
                    </div>
            ...
            <div class="card-body pt-5 pb-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="key" value="{{$razorpayInfo['key']}}">
                        @if ($errors->has('key'))
                            <p class="mb-0 text-danger">{{$errors->first('key')}}</p>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="secret" value="{{$razorpayInfo['secret']}}">
                        @if ($errors->has('secret'))
                            <p class="mb-0 text-danger">{{$errors->first('secret')}}</p>
                        @endif
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="key" value="{{$payumoneyInfo['key']}}">
                            @if ($errors->has('key'))
                                <p class="mb-0 text-danger">{{$errors->first('key')}}</p>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="salt" value="{{$payumoneyInfo['salt']}}">
                            @if ($errors->has('salt'))
        ...
        <div class="card">
            ...
            <div class="card-body pt-5 pb-5">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="token" value="{{$mercadopagoInfo['token']}}">
                        @if ($errors->has('token'))
                            <p class="mb-0 text-danger">{{$errors->first('token')}}</p>
                        @endif
                    </div>
