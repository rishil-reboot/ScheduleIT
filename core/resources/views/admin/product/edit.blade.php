              ...
              <form id="ajaxForm" class="" action="{{route('admin.product.update')}}" method="post">
                ...
                <div class="row">
                    ...
                    <?php 
                        ...
                        $productTemplate = \App\ProductTemplate::where('status',1)->pluck('name','id')->toArray();
                     ?>
                    <div class="col-lg-12">
                       <div class="form-group">
                          <label for="">Product Template **</label>
                          <select class="form-control ltr" name="product_template_id">
                              <option value="" selected disabled>Select a product template</option>
                             @if(isset($productTemplate) && !empty($productTemplate))
                                @foreach($productTemplate as $key=>$v)
                                   <option value="{{$key}}" @if($data->product_template_id ==$key) selected @endif>{{$v}}</option>
                                @endforeach
                             @endif
                           </select>
                           <p id="errproduct_template_id" class="mb-0 text-danger em"></p>
                       </div>
                    </div>
                ...
                <div class="row">
                   <div class="col-lg-12">
                    ...
                    <div class="subcategoryData" style="margin-left:16px;"></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                       <div class="form-group">
                          <input type="checkbox" @if($data->call_for_price == 1) checked @endif class="call_for_price" name="call_for_price" value="1">
                          <label for="">Is Call for Price ? </label>
                          <p id="errcall_for_price" class="mb-0 text-danger em"></p>
                       </div>
                    </div>
                 </div>
                ...
                <div class="row call_div">
                    <div class="col-lg-12">
                       <div class="form-group">
                          <label for=""> Phone Number **</label>
                          <input type="text" class="form-control ltr" name="phone_number" value="{{$data->phone_number}}"  placeholder="Enter Phone Number">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="checkbox" class="" name="is_featured" value="1" @if($data->is_featured == 1) checked @endif>
                ...
                <div class="row">
                  ...
                  <?php 
                    ...
                    $productDataTypeArray = $data->productDataType->pluck('product_type_id')->toArray();
                 ...
                 @if(isset($productType) && !empty($productType))
                    <div class="row">
                       ...
                       @foreach($productType as $key=>$v)
                          <div class="col-md-4">
                             <div class="form-group">
                                <input type="checkbox" @if(in_array($key,$productDataTypeArray)) checked @endif name="product_type_id[]" value="{{$key}}">
                                <label for="">{{$v}}</label>
                             </div>
                          </div>
                       @endforeach
...
@section('scripts')
  ...
  $(document).ready(function(){
    ...
    $(document).on("change",".call_for_price",function(){
    ...
    function callForPrice(){
        ...
        var isChecked = $(".call_for_price").is(":checked");
