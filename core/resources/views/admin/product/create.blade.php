               ...
               <div class="col-lg-8 offset-lg-2">
                  ...
                  <form id="ajaxForm" class="" action="{{route('admin.product.store')}}" method="post">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <input type="checkbox" class="call_for_price" name="call_for_price" value="1">
                     ...
                     <div class="row call_div">
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control ltr" name="phone_number" value=""  placeholder="Enter Phone Number">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="checkbox" class="" name="is_featured" value="1">
                     ...
                     @if(isset($productType) && !empty($productType))
                        <div class="row">
                           ...
                           @foreach($productType as $key=>$v)
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <input type="checkbox" name="product_type_id[]" value="{{$key}}">
                                    <label for="">{{$v}}</label>
                                 </div>
                              </div>
                           @endforeach
