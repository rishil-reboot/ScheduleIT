                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{ $slider->title }}" name="title" placeholder="Enter Title" />
                ...
                @if (getVersion($be->theme_version) != 'cleaning')
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control summernote" name="text" placeholder="Enter Text">{!! $slider->text !!}</textarea>
