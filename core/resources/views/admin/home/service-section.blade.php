            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.servicesection.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea name="service_section_content" class="form-control summernote">{!! $abs->service_section_content !!}</textarea>
                  <p id="errservice_section_content" class="em text-danger mb-0"></p>
                </div>
              </form>
