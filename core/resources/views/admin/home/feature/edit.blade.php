            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                      ...
                      <select name="page_id" class="form-control">
                          ...
                          @if(isset($pages) && !$pages->isEmpty())
                            @foreach ($pages as $page)
                                <option value="{{$page->id}}" @if($feature->page_id == $page->id) selected @endif>{{$page->title}}</option>
                            @endforeach
                          @endif
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="subtitle" placeholder="Enter Subtitle" value="{{$feature->subtitle}}">
                    @if ($errors->has('subtitle'))
                      <p class="mb-0 text-danger">{{$errors->first('subtitle')}}</p>
                    @endif
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="external_link" value="{{$feature->external_link}}" placeholder="Enter external link">
