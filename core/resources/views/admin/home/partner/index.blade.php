    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form class="" action="{{ route('admin.partner.updateSection') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Title **</label>
                                    <input class="form-control" name="partner_section_title"
                                        value="{{ $abs->partner_section_title }}" placeholder="Enter Title">
                                    @if ($errors->has('partner_section_title'))
                                        <p class="mb-0 text-danger">{{ $errors->first('partner_section_title') }}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="partner_section_subtitle"
                                        value="{{ $abs->partner_section_subtitle }}" placeholder="Enter Subtitle">
                                    @if ($errors->has('partner_section_subtitle'))
                                        <p class="mb-0 text-danger">{{ $errors->first('partner_section_subtitle') }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="partner_section_description" data-editor="partner_section_description">
                    {!! $abs->partner_section_description !!}
                  </textarea>
                                    @if ($errors->has('partner_section_description'))
                                        <p class="mb-0 text-danger">{{ $errors->first('partner_section_description') }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="partner_meta_keyword"
                                        value="{{ $bs->partner_meta_keyword }}" placeholder="Enter meta keywords"
                                        data-role="tagsinput">
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="partner_meta_description" rows="5" placeholder="Enter meta description">{!! $bs->partner_meta_description !!}</textarea>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data"
                        action="{{ route('admin.partner.upload') }}" method="POST">
                        <div class="form-row px-2">
                            ...
                            <div class="col-sm-12">
                                <div class="from-group mb-2">
                                    <input type="text" class="form-control progressbar" aria-describedby="fileHelp"
                                        placeholder="No image uploaded..." readonly="readonly" />
                    ...
                    <form id="ajaxForm" class="modal-form" action="{{ route('admin.partner.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" onkeyup="makeslug(this.value)" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="long_description" class="form-control summernote" data-editor="long_description" placeholder="Enter Description"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="company_address" class="form-control summernote" data-editor="company_address" placeholder="Enter Company Address"
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>The higher the serial number is, the later the partner will be
                                    shown.</small></p>
                        </div>

                        <div class="form-group">
                            <label>Meta Keywords</label>
                            <input class="form-control" name="meta_keyword" value=""
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("select[name='language_id']").on('change', function() {
                ...
                let langid = $(this).val();
                let urlProduct = "{{ url('/') }}/admin/partner/" + langid + "/getProduct";
                // console.log(url);
