            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" name="testimonial_meta_keyword" value="{{$abe->testimonial_meta_keyword}}" placeholder="Enter meta keywords" data-role="tagsinput">
                  </div>
              </div>
              <div class="col-lg-6">
                 <div class="form-group">
                    <label>Meta Description</label>
                    <textarea class="form-control" name="testimonial_meta_description" rows="5" placeholder="Enter meta description">{{$abe->testimonial_meta_description}}</textarea>
                  </div>
              </div>
