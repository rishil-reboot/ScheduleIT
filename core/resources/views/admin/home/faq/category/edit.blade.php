...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Edit FAQ Category</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Edit FAQ Category</div>
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{route('admin.faq-category.index') . '?language=' . request()->input('language')}}">
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.faq-category.update')}}" method="post">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="slug" placeholder="Enter SEO Friendly URL Slug" value="{{$scategory->slug}}">
