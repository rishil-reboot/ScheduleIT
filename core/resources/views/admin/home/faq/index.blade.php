                    ...
                    <tbody>
                      @foreach ($faqs as $key => $faq)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn" href="{{route('admin.faq.edit',$faq->id).'?language='.$faq->language->code}}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data" action="{{route('admin.faq.upload')}}" method="POST">
             <div class="form-row px-2">
                ...
                <div class="col-sm-12">
                   ...
                   <div class="mt-4">
                      ...
                      <p class="em text-danger mb-0" id="errfaq_image"></p>
                   </div>
                </div>
             </div>
          </form>
