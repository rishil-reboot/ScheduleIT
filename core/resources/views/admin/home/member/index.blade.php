...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data"
                        action="{{ route('admin.team.upload', $lang_id) }}" method="POST">
                        <div class="row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 d-md-block mb-3">
                                        @if (!empty($abs->team_bg))
                                            <img src="{{ asset('assets/front/img/' . $abs->team_bg) }}" alt="..."
                                                class="img-thumbnail">
                                        @else
                                        ...
                                        <tbody>
                                            @foreach ($members as $key => $member)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('assets/front/img/members/' . $member->image) }}"
                                                            alt="" width="40"></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-secondary btn-sm get-my-preview"
                                                            data-id="{{ $member->id }}" href="javascript:void(0)">
                                                            <span class="btn-label">
    ...
    <div class="modal fade show" id="previewDataPopup">
