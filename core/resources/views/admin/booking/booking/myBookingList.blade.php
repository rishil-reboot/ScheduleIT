...
<style>
  ...
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">My Booking Management</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
         <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">My Bookings</div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="box-body table-responsive">
                    <div class="row no-gutters mrgn_10b">
                        <div class="col-md-10">
                            {!! Form::open(array('route' => 'admin.mybooking.search', 'id' => 'booking-search-form', 'class' => 'form-inline','method' => 'POST')) !!}
                            ...
                            @foreach ($bookings as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-xs btn-danger" style="color:white" title="{!! trans('admin/booking.cancelled_booking') !!}" data-toggle="tooltip">{!! trans('admin/booking.'.$data->status) !!}</a>
                                        @elseif($data->status == 'confirm')
                                        <a class="btn btn-xs btn-success" style="color:white" title="{!! trans('admin/booking.confirmed_booking') !!}" data-toggle="tooltip">{!! trans('admin/booking.'.$data->status) !!}</a>
                                        @endif
                                    </td>
                                    <td>
                                        @if(isset($data->actionBy) && $data->actionBy !=null)
                                            {{$data->actionBy->first_name}} {{$data->actionBy->last_name}} 
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{url('admin/booking')}}/{!! $data->id !!}" id="{!! $data->id !!}" class="btn btn-xs btn-primary view-btn" title="{!! trans('admin/common.view') !!}" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            @else
