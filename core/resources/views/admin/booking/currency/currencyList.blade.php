    ...
    <div class="col-md-12">
      ...
      <div class="card">
         <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">Currency</div>
                </div>
                <div class="col-lg-3"></div>
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="{{route('currency.create')}}" class="btn btn-primary float-right btn-sm"><i class="fas fa-plus"></i> Add Currency</a>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="currency_list" class="table table-striped mt-3">
                        <thead>
                            <tr>
                                <th scope="col">{!! trans('admin/currency.currency_name') !!}</th>
                                <th scope="col">{!! trans('admin/currency.currency_code') !!}</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        oTable = $('#currency_list').dataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('admin.currency.getCurrencyData') }}",
            "columnDefs": [
