              ...
              <form id="permissionsForm" class="" action="{{route('admin.role.permissions.update')}}" method="post">
                ...
                <div class="form-group">
                  <label for="">Permissions: </label>
                    ...
                    <label class="selectgroup-item">
                      <input type="checkbox" name="permissions[]" value="Education Management" class="selectgroup-input" @if(is_array($permissions) && in_array('Education Management', $permissions)) checked @endif>
                      <span class="selectgroup-button">Education Management</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="checkbox" name="permissions[]" value="Booking Management" class="selectgroup-input" @if(is_array($permissions) && in_array('Booking Management', $permissions)) checked @endif>
                      <span class="selectgroup-button">Booking Management</span>
                    </label>
                		<label class="selectgroup-item">
						...
						<label class="selectgroup-item">
                			<input type="checkbox" name="permissions[]" value="FormBuilder" class="selectgroup-input" @if(is_array($permissions) && in_array('FormBuilder', $permissions)) checked @endif>
                			<span class="selectgroup-button">Form Builder</span>
                		</label>
                		<label class="selectgroup-item">
						...
						<label class="selectgroup-item">
                            <input type="checkbox" name="permissions[]" value="Videos" class="selectgroup-input" @if(is_array($permissions) && in_array('Videos', $permissions)) checked @endif>
                            <span class="selectgroup-button">Videos</span>
                        </label>
                		<label class="selectgroup-item">
                		...
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">General Calendar</span>
                		</label>
                		<label class="selectgroup-item">
                			...
                			<span class="selectgroup-button">Media Management</span>
                		</label>
                		<label class="selectgroup-item">
                        ...
                        <label class="selectgroup-item">
                			<input type="checkbox" name="permissions[]" value="Technicians Management" class="selectgroup-input" @if(is_array($permissions) && in_array('Technicians Management', $permissions)) checked @endif>
                			<span class="selectgroup-button">Technicians Management</span>
                		</label>
                        <label class="selectgroup-item">
                			<input type="checkbox" name="permissions[]" value="Customers Management" class="selectgroup-input" @if(is_array($permissions) && in_array('Customers Management', $permissions)) checked @endif>
                			<span class="selectgroup-button">Customers Management</span>
                		</label>
                    ...
                    <label class="selectgroup-item">
                        <input type="checkbox" name="permissions[]" value="Inbox" class="selectgroup-input" @if(is_array($permissions) && in_array('Inbox', $permissions)) checked @endif>
                        <span class="selectgroup-button">Inbox</span>
                    </label>
                    <label class="selectgroup-item">
                        <input type="checkbox" name="permissions[]" value="ChatDashboard" class="selectgroup-input" @if(is_array($permissions) && in_array('ChatDashboard', $permissions)) checked @endif>
                        <span class="selectgroup-button">Chat Dashboard</span>
                    </label>
                	</div>
                </div>
              </form>
