          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  <label>Matomo Status</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="is_matomo" value="1" class="selectgroup-input" {{$bs->is_matomo == 1 ? 'checked' : ''}}>
                      <span class="selectgroup-button">Active</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="radio" name="is_matomo" value="0" class="selectgroup-input" {{$bs->is_matomo == 0 ? 'checked' : ''}}>
                      <span class="selectgroup-button">Deactive</span>
                    </label>
                  </div>
                  @if ($errors->has('is_matomo'))
                    <p class="mb-0 text-danger">{{$errors->first('is_matomo')}}</p>
                  @endif
                </div>
                <div class="form-group">
                  <label>Matomo Script</label>
                  <textarea class="form-control" name="matomo_script" rows="5">{{$bs->matomo_script}}</textarea>
                  @if ($errors->has('matomo_script'))
                    <p class="mb-0 text-danger">{{$errors->first('matomo_script')}}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="google_recaptcha_site_key" value="{{$bs->google_recaptcha_site_key}}">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="google_recaptcha_secret_key" value="{{$bs->google_recaptcha_secret_key}}">
