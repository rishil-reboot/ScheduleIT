          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  <label>Education Article Title **</label>
                  <input class="form-control" name="education_article_title" value="{{$abs->education_article_title}}">
                  @if ($errors->has('education_article_title'))
                    <p class="mb-0 text-danger">{{$errors->first('education_article_title')}}</p>
                  @endif
                </div>
                <div class="form-group">
                  <label>Education Article Subtitle **</label>
                  <input class="form-control" name="education_article_subtitle" value="{{$abs->education_article_subtitle}}">
                  @if ($errors->has('education_article_subtitle'))
                    <p class="mb-0 text-danger">{{$errors->first('education_article_subtitle')}}</p>
                  @endif
                </div>
                <div class="form-group">
                  <label>Education Article Details Title **</label>
                  <input class="form-control" name="education_article_details_title" value="{{$abs->education_article_details_title}}">
                  @if ($errors->has('education_article_details_title'))
                    <p class="mb-0 text-danger">{{$errors->first('education_article_details_title')}}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="feature_section_title" value="{{$abs->feature_section_title}}">
                    @if ($errors->has('feature_section_title'))
                      <p class="mb-0 text-danger">{{$errors->first('feature_section_title')}}</p>
                    @endif
                  </div>
                  <div class="form-group">
                    <label>Feature section Subtitle **</label>
                    <input class="form-control" name="feature_section_subtitle" value="{{$abs->feature_section_subtitle}}">
                    @if ($errors->has('feature_section_subtitle'))
                      <p class="mb-0 text-danger">{{$errors->first('feature_section_subtitle')}}</p>
                    @endif
                  </div>

                  <div class="form-group">
                    <label>Statistics section title **</label>
                    <input class="form-control" name="statistics_section_title" value="{{$abs->statistics_section_title}}">
                    @if ($errors->has('statistics_section_title'))
                      <p class="mb-0 text-danger">{{$errors->first('statistics_section_title')}}</p>
                    @endif
                  </div>
                  <div class="form-group">
                    <label>Statistics section Subtitle **</label>
                    <input class="form-control" name="statistics_section_subtitle" value="{{$abs->statistics_section_subtitle}}">
                    @if ($errors->has('statistics_section_subtitle'))
                      <p class="mb-0 text-danger">{{$errors->first('statistics_section_subtitle')}}</p>
                    @endif
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="steps_section_title" value="{{$abs->steps_section_title}}">
                    @if ($errors->has('steps_section_title'))
                      <p class="mb-0 text-danger">{{$errors->first('steps_section_title')}}</p>
                    @endif
                  </div>
                  <div class="form-group">
                    <label>Steps section subtitle **</label>
                    <input class="form-control" name="steps_section_subtitle" value="{{$abs->steps_section_subtitle}}">
                    @if ($errors->has('	steps_section_subtitle'))
                      <p class="mb-0 text-danger">{{$errors->first('steps_section_subtitle')}}</p>
                    @endif
                  </div>
