               ...
               <div class="col-lg-12">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        @if($ticket->zip_file)
                        <a href="{{asset('assets/front/user-support-file/'.$ticket->zip_file)}}" download="{{__('support_file')}}" class="btn btn-primary"><i class="fas fa-download"></i> Download Attachment</a>
                        @endif
                     </div>
                  </div>
               </div>
                ...
                @foreach ($ticket->messages as $reply)
                   ...
                   <div class="item-list">
                      ...
                      <div class="info-user ml-3">
                         ...
                         @if($reply->file)
                         <a href="{{asset('assets/front/user-support-file/'.$ticket->zip_file)}}" download="support_file" class="btn btn-rounded btn-info btn-sm">Download</a>
                         @endif
                      </div>
                   </div>
                  @else
