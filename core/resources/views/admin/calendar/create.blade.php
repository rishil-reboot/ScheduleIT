      ...
      <div class="card">
       <form action="{{route('admin.calendar.store')}}" method="post">
          <div class="card-header">
            <div class="card-title d-inline-block">Create Event</div>
          ...
          <div class="card-body pt-5 pb-5">
                   ...
                   <div class="col-lg-6 offset-lg-3">
                      <div class="form-group">
                        ...
                        <label class="control-label offset-lg-1">
                          <input type="radio" name="is_recurring" class="is_recurring" value="1" checked="checked">
                          None
                        </label>
                        <label class="control-label offset-lg-1">
                          <input type="radio" name="is_recurring" class="is_recurring" value="2">
                          Custom
                        </label>
                      </div>
                  </div>
              ...
              <div class="col-lg-6 offset-lg-3 show_hide_recurring_class" style="display: none;">
                ...
                <div class="form-group">
                  ...
                  <label class="control-label offset-lg-1">
                    <input type="radio" name="recurring_end_action" class="recurring_end_action" value="never" checked="checked">
                    Never 
                  </label>
                  <label class="control-label offset-lg-1">
                    <input type="radio" name="recurring_end_action" class="recurring_end_action" value="after">
                    After
                  </label>
                  <label class="control-label offset-lg-1">
                    <input type="radio" name="recurring_end_action" class="recurring_end_action" value="date">
                    On date 
                  </label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="form-group">
                      ...
                      <textarea class="form-control summernote" name="event_note" rows="3" data-editor="event_note" placeholder="Enter Note" data-height="100"></textarea>
              ...
              <div class="col-lg-6 offset-lg-3">
                  <div class="form-group">
                      ...
                      <label class="control-label" style="margin-left:10px">
                        <input type="checkbox" name="is_featured" value="1" class="is_featured">
                      </label>
                  </div>
              </div>
  ...
  function repeatChangeTypeAction(page)
    {   
      ...
      $.ajax({
       ...
       data:{"_token": "{{ csrf_token() }}",repeatType:repeatType},
  ...
  function endActionChange()
    {   
      ...
      $.ajax({
       ...
       data:{"_token": "{{ csrf_token() }}",endAction:endAction},
       success:function(data)
       {
