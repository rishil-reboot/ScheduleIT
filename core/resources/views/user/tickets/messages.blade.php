                        ...
                        <div class="user-profile-details">
                            <div class="account-info">
                                ...
                                <div class="summary">
                                    ...
                                    @if($ticket->zip_file)
                                    <a href="{{asset('assets/front/user-support-file/'.$ticket->zip_file)}}" download="support.zip" class="btn btn-primary"><i class="fas fa-download"></i> Download Attachment</a>
                                    @endif
                                </div>
                                        ...
                                        <div class="single-message">
                                            <div class="user-details">
                                                ...
                                                <div class="user-infos">
                                                    ...
                                                    @if($reply->file)
                                                        <a href="{{asset('assets/front/user-support-file/'.$reply->file)}}" download="support.zip" class="reply-download-btn"><i class="fas fa-download"></i> {{__('Download')}}</a>
                                                        @endif
                                                </div>
                                            </div>
