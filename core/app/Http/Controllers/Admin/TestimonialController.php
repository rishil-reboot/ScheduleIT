...
class TestimonialController extends Controller
{
    ...
    public function textupdate(Request $request, $langid)
    {
        $request->validate([
            ...
            'testimonial_section_subtitle' => 'required|max:500',
        ]);
        ...
        $be = BE::where('language_id', $langid)->firstOrFail();
        $be->testimonial_meta_keyword = $request->testimonial_meta_keyword;
        $be->testimonial_meta_description = $request->testimonial_meta_description;
        $be->save();
