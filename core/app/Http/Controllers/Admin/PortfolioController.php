...
class PortfolioController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['bcats'] = PortfolioCategory::where('language_id', $data['portfolio']->language_id)->where('status', 1)->get();
    ...
    public function store(Request $request)
    {
        ...
        if (isset($input['category_id']) && !empty($input['category_id'])) {
            ...
            foreach($input['category_id'] as $key=>$v){

                $obj = new MyPortfolioCategory;
    ...
    public function update(Request $request)
    {
        ...
        MyPortfolioCategory::where('portfolio_id',$request->portfolio_id)->delete();
