...
class GatewayController extends Controller
{
    ...
    public function paypalUpdate(Request $request) {
        ...
        $fields = json_decode($paypal->information,true);

        $paypal->status = $request->status;

        $information = [];

        $information['client_id'] = CommonFunctionForMailString($request->client_id,$fields['client_id'],100);

        $information['client_secret'] = CommonFunctionForMailString($request->client_secret,$fields['client_secret'],100);
    ...
    public function stripeUpdate(Request $request) {
        ...
        $fields = json_decode($stripe->information,true);

        $information['key'] = CommonFunctionForMailString($request->key,$fields['key'],100);

        $information['secret'] = CommonFunctionForMailString($request->secret,$fields['secret'],100);
    ...
    public function paystackUpdate(Request $request) {
        ...
        $fields = json_decode($paystack->information,true);
    ...
    public function paytmUpdate(Request $request) {
        ...
        $fields = json_decode($paytm->information,true);

        $information['merchant'] = CommonFunctionForMailString($request->merchant,$fields['merchant'],100);
    ...
    public function flutterwaveUpdate(Request $request) {
        ...
        $fields = json_decode($flutterwave->information,true);

        $information['public_key'] = CommonFunctionForMailString($request->public_key,$fields['public_key'],100);

        $information['secret_key'] = CommonFunctionForMailString($request->secret_key,$fields['secret_key'],100);
    ...
    public function instamojoUpdate(Request $request) {
        ...
        $fields = json_decode($instamojo->information,true);

        $information['key'] = CommonFunctionForMailString($request->key,$fields['key'],100);

        $information['token'] = CommonFunctionForMailString($request->token,$fields['token'],100);
    ...
    public function mollieUpdate(Request $request) {
        ...
        $fields = json_decode($mollie->information,true);
    ...
    public function razorpayUpdate(Request $request) {
        ...
        $fields = json_decode($razorpay->information,true);
    ...
    public function mercadopagoUpdate(Request $request) {
        ...
        $fields = json_decode($mercadopago->information,true);
    ...
    public function payumoneyUpdate(Request $request) {
        ...
        $fields = json_decode($payumoney->information,true);
        
        $information['key'] = CommonFunctionForMailString($request->key,$fields['key'],100);

        $information['salt'] = CommonFunctionForMailString($request->salt,$fields['salt'],100);
