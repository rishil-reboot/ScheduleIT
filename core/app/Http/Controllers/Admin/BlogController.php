...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $blog->publish_at = (isset($request->publish_at) && $request->publish_at !='') ? $request->publish_at : Null;
        $blog->gallery_id = (isset($request->gallery_id) && $request->gallery_id !='') ? $request->gallery_id : Null;
        $blog->adverticement_id = $request->adverticement_id;
        $blog->save();
