    ...
    public function product(Request $request)
    {
        ...
        $data['products'] =
            ...
            ->when($ptype, function ($query, $ptype) {
                ...
                return $query->whereHas('productDataType',function($qc) use($ptype){

                            $qc->where('product_type_id',$ptype);

                        });
            })
            ->when($scategory, function ($query, $scategory) {

                return $query->whereHas('productSubCategoryData',function($qc) use($scategory){

                            $qc->where('sub_category_id',$scategory);
            ...
            {
                return view('front.theme.products',$data);
            }
