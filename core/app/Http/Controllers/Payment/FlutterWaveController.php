...
class FlutterWaveController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->public_key = \Crypt::decryptString($paydata['public_key']);
        $this->secret_key = \Crypt::decryptString($paydata['secret_key']);
    }
    ...
    public function store(Request $request)
    {
        ...
        $cancel_url = route('front.payment.cancle', $package->slug);
    ...
    public function notify(Request $request)
    {
        ...
        $packageInfoDetail = \App\Package::where('id',$packageid)->firstOrFail(); 
        $cancel_url = route('front.payment.cancle', $packageInfoDetail->slug);
                    ...
                    if ($be->is_smtp == 1) {
                        ...
                        if (isset($emailTemplate) && !empty($emailTemplate)) {
                            ...
                            try {
                                ...
                                $emailTemplate->subject = str_replace(array('###PACKAGE_TITLE###'), array($po->package_title), $emailTemplate->subject);
