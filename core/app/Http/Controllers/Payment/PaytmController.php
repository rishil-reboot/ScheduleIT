...
class PaytmController extends Controller
{
    ...
    public function handlePaytmRequest($order_id, $amount)
    {
        ...
        $paramList["MID"] = \Crypt::decryptString($paydata['merchant']);
        ...
        $paytm_merchant_key = \Crypt::decryptString($paydata['secret']);
    ...
    public function notify(Request $request)
    {
        if ('TXN_SUCCESS' === $request['STATUS']) {
            ...
            $packageInfoDetail = \App\Package::where('id',Session::get('package_id'))->firstOrFail();
            return redirect(route('front.payment.cancle', $packageInfoDetail->slug));
        }
